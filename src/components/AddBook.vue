...
<template>
    ...
    <div class="header-btns">
        <button @click="$emit('closeAddBook')" class="btn">
            Fechar x
        </button>
    </div>
    ...
    <form class="add-form">
        ...
        <div class="form-control">
            <label>Capa</label>
            <input type="text" name="cover" placeholder="Adicione o link da imagem de capa" v-model="newBook.cover" required/>
        </div>
        <div class="form-control">
            <label>Autor</label>
            <input type="text" name="author" placeholder="Adicione o autor" v-model="newBook.author" required/>
        </div>
        <div class="form-control">
            <label>ISBN#</label>
